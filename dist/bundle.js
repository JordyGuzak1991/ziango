...
exports.default = {
  ...
  scaleRatio: function scaleRatio() {
    return this.aspectRatio > 1 ? this.gameHeight / 2048 : this.gameWidth / 2048;
  }
};
...
module.exports = __webpack_require__(/*! C:\Users\Jordy\GitHub\ziango\src\main.js */333);
...
var _Ball = __webpack_require__(/*! ../sprites/Ball */ 343);

var _Ball2 = _interopRequireDefault(_Ball);

var _Crosshair = __webpack_require__(/*! ../sprites/Crosshair */ 344);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function create() {
      ...
      var whiteballCollisionGroup = this.game.physics.p2.createCollisionGroup();
      var ballsCollisionGroup = this.game.physics.p2.createCollisionGroup();

      // This part is vital to make objects with their own collision groups still collide with the world bounds
      this.game.physics.p2.updateBoundsCollisionGroup();

      // Create white ball
      this.whiteBall = new _Ball2.default({
        game: this.game,
        x: this.world.centerX,
        y: this.world.centerY,
        asset: 'white-ball',
        scale: _config2.default.scaleRatio() / 6
      });
      ...
      for (var i = 0; i < this.nrOfBalls; i++) {
        var randomPosition = this.getRandomPosition();
        var asset = this.game.math.isEven(i) ? 'red-ball' : 'orange-ball';
        ...
        var ball = new _Ball2.default({
          ...
          y: randomPosition.y,
          asset: asset,
          scale: asset == 'orange-ball' ? _config2.default.scaleRatio() / 2 : _config2.default.scaleRatio()
        });
      ...
      // Create crosshair
      this.crosshair = new _Crosshair2.default({
        game: this.game,
      ...
      this.line = new _phaser2.default.Line(0, 0, 0, 0);
    ...
    key: 'onHitBall',
    value: function onHitBall(body1, body2) {
    ...
    value: function shoot() {
      var newVelocity = _phaser2.default.Point.subtract(this.crosshair.position, this.whiteBall.position).normalize().setMagnitude(this.force);
    ...
    value: function reset(delay) {
      ...
      setTimeout(function () {
        ...
        self.ballsGroup.forEach(function (ball) {
          var randomPosition = self.getRandomPosition();
    ...
    value: function getRandomPosition() {
      return { x: this.game.rnd.between(50, _config2.default.gameWidth - 50), y: this.game.rnd.between(50, _config2.default.gameHeight - 50) };
    }
  }]);
...
var _class = function (_Phaser$Sprite) {
    ...
    function _class(_ref) {
        ...
        _this.anchor.setTo(0.5);
        _this.scale.setTo(_config2.default.scaleRatio(), _config2.default.scaleRatio());
